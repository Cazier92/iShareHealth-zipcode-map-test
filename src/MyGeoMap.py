...
df_zipcodes = pd.read_csv('/Users/Bryce/code/React-Native/TOP2023/iHealthShare/data/csv/zipcode_to_county.csv')
df = pd.read_csv('/Users/Bryce/code/React-Native/TOP2023/iHealthShare/data/csv/covid_cases_fips_wa.csv')
...
if not os.path.exists("/Users/Bryce/code/React-Native/TOP2023/iHealthShare/images"):
    os.mkdir("./images")
fig.write_html("/Users/Bryce/code/React-Native/TOP2023/iHealthShare/images/mymap.html")
